...
execute if score UHCMM uhcEnabled matches 1 if score UHC uhcMin = UHC uhcNextMM if score UHC uhcMin matches 1.. as @a at @s run playsound entity.firework_rocket.launch voice @s ~ ~ ~ 0.7 0.5 1
